...
本仓库是 [Skarian/vr2xr](https://github.com/skarian/vr2xr) 的持续维护分支。原项目及作者信息见文末，本分支特有的改动见[相较原项目的改动](#相较原项目的改动)。
...
- **多种 VR180 投影**：支持半球等距柱状、等距鱼眼和等立体角鱼眼投影
...
对比基线为原项目 `main` 分支的 [`52673c5`](https://github.com/skarian/vr2xr/commit/52673c58b376c96a19426bf2a1cff24bd0484685) 提交。本分支目前包含以下改动：
...
| 投影模式 | 在原有半球等距柱状模式之外，新增 VR180 等距鱼眼和等立体角鱼眼渲染。 |
